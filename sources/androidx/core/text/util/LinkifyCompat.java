...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator() { // from class: androidx.core.text.util.LinkifyCompat$$ExternalSyntheticLambda1
    ...
    static /* synthetic */ int lambda$static$0(LinkSpec linkSpec, LinkSpec linkSpec2) {
        ...
        return Person$$ExternalSyntheticBackport0.m(linkSpec2.end, linkSpec.end);
    }
