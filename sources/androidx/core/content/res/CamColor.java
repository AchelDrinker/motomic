...
public class CamColor {
    ...
    private static CamColor fromJchInFrame(float f, float f2, float f3, ViewingConditions viewingConditions) {
        ...
        return new CamColor(f3, f2, f, fSqrt, flRoot, fSqrt2, f4, ((float) Math.cos(d3)) * fLog, fLog * ((float) Math.sin(d3)));
    }
    ...
    int viewed(ViewingConditions viewingConditions) {
        ...
        Double.isNaN(Math.abs(f6));
        float fSignum2 = Math.signum(f6) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((float) Math.max(0.0d, (r11 * 27.13d) / (400.0d - r1)), 2.380952380952381d));
        Double.isNaN(Math.abs(f7));
        Double.isNaN(Math.abs(f7));
        float fSignum3 = Math.signum(f7) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((float) Math.max(0.0d, (r11 * 27.13d) / (400.0d - r9)), 2.380952380952381d));
