...
public final class ColorUtils {
    ...
    static class Api26Impl {
        ...
        static Color compositeColors(Color color, Color color2) {
            if (!Person$$ExternalSyntheticBackport0.m6m((Object) color.getModel(), (Object) color2.getModel())) {
                throw new IllegalArgumentException("Color models must match (" + color.getModel() + " vs. " + color2.getModel() + ")");
            }
            if (!Person$$ExternalSyntheticBackport0.m6m((Object) color2.getColorSpace(), (Object) color.getColorSpace())) {
