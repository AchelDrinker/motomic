...
public final class PathParser {
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException("error in parsing \"" + str + Common.QUOTE, e);
        }
    }
    ...
    */
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            Double.isNaN(d12);
            Double.isNaN(d5);
            double d13 = (d11 + (d12 * dSin)) / d5;
            double d14 = -f3;
            Double.isNaN(d14);
            Double.isNaN(d12);
            Double.isNaN(d8);
            double d15 = ((d14 * dSin) + (d12 * dCos)) / d8;
            double d16 = d6 - d13;
            double d17 = d9 - d15;
            double d18 = (d6 + d13) / 2.0d;
            ...
            double dAtan22 = Math.atan2(d15 - d2, d13 - d) - dAtan2;
            if (z2 != (dAtan22 >= 0.0d)) {
            ...
            Double.isNaN(d8);
            double d25 = d2 * d8;
            arcToBezier(path, (d24 * dCos) - (d25 * dSin), (d24 * dSin) + (d25 * dCos), d5, d8, d3, d4, radians, dAtan2, dAtan22);
        }
