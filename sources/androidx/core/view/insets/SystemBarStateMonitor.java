...
class SystemBarStateMonitor {
    ...
    SystemBarStateMonitor(final ViewGroup viewGroup) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view, new OnApplyWindowInsetsListener() { // from class: androidx.core.view.insets.SystemBarStateMonitor$$ExternalSyntheticLambda0
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat) {
                return this.f$0.m32lambda$new$0$androidxcoreviewinsetsSystemBarStateMonitor(view2, windowInsetsCompat);
            }
        });
    ...
    /* synthetic */ WindowInsetsCompat m32lambda$new$0$androidxcoreviewinsetsSystemBarStateMonitor(View view, WindowInsetsCompat windowInsetsCompat) {
    ...
    void detachFromWindow() {
        this.mDetector.post(new Runnable() { // from class: androidx.core.view.insets.SystemBarStateMonitor$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m31lambda$detachFromWindow$1$androidxcoreviewinsetsSystemBarStateMonitor();
            }
        });
    }
    ...
    /* synthetic */ void m31lambda$detachFromWindow$1$androidxcoreviewinsetsSystemBarStateMonitor() {
