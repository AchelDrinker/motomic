    ...
    */
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                scrollBy(-((int) (axisValue * getVerticalScrollFactorCompat())), i, motionEvent, width, 1, MotionEventCompat.isFromSource(motionEvent, InputDeviceCompat.SOURCE_MOUSE));
                if (i == 0) {
                    return true;
                }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    boolean overScrollByCompat(int r12, int r13, int r14, int r15, int r16, int r17, int r18, int r19, boolean r20) {
        /*
            r11 = this;
