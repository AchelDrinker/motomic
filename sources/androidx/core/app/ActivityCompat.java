...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(final Activity activity, String[] strArr, final int i) {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                ...
                if (Build.VERSION.SDK_INT < 33 && TextUtils.equals(strArr[i2], RuntimePermissions.PERMISSION_POST_NOTIFICATIONS)) {
    ...
    public static boolean shouldShowRequestPermissionRationale(Activity activity, String str) {
        if (Build.VERSION.SDK_INT < 33 && TextUtils.equals(RuntimePermissions.PERMISSION_POST_NOTIFICATIONS, str)) {
            return false;
        }
