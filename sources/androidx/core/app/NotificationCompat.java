...
public class NotificationCompat {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                if (size != this.mMessages.size() - 1) {
                    spannableStringBuilder.insert(0, (CharSequence) Common.CRLF);
                }
    ...
    public static class CallStyle extends Style {
        ...
        public static CallStyle forIncomingCall(Person person, PendingIntent pendingIntent, PendingIntent pendingIntent2) {
            return new CallStyle(1, person, null, (PendingIntent) Person$$ExternalSyntheticBackport0.m((Object) pendingIntent, "declineIntent is required"), (PendingIntent) Person$$ExternalSyntheticBackport0.m((Object) pendingIntent2, "answerIntent is required"));
        }

        public static CallStyle forOngoingCall(Person person, PendingIntent pendingIntent) {
            return new CallStyle(2, person, (PendingIntent) Person$$ExternalSyntheticBackport0.m((Object) pendingIntent, "hangUpIntent is required"), null, null);
        }

        public static CallStyle forScreeningCall(Person person, PendingIntent pendingIntent, PendingIntent pendingIntent2) {
            return new CallStyle(3, person, (PendingIntent) Person$$ExternalSyntheticBackport0.m((Object) pendingIntent, "hangUpIntent is required"), null, (PendingIntent) Person$$ExternalSyntheticBackport0.m((Object) pendingIntent2, "answerIntent is required"));
        }
