...
public class FontsContractCompat {
    ...
    public static FontFamilyResult fetchFonts(Context context, CancellationSignal cancellationSignal, FontRequest fontRequest) throws PackageManager.NameNotFoundException {
        return FontProvider.getFontFamilyResult(context, Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), cancellationSignal);
    }
    ...
    public static void requestFont(Context context, FontRequest fontRequest, FontRequestCallback fontRequestCallback, Handler handler) {
        ...
        FontRequestWorker.requestFontAsync(context.getApplicationContext(), Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), 0, RequestExecutor.createHandlerExecutor(handler), callbackWrapper);
    }
    ...
    public static void requestFont(Context context, FontRequest fontRequest, int i, Executor executor, Executor executor2, FontRequestCallback fontRequestCallback) {
        FontRequestWorker.requestFontAsync(context.getApplicationContext(), Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i, executor, new CallbackWrapper(fontRequestCallback, executor2));
    }
    ...
    public static Typeface requestFont(Context context, FontRequest fontRequest, int i, boolean z, int i2, Handler handler, FontRequestCallback fontRequestCallback) {
        return requestFont(context, (List<FontRequest>) Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i, z, i2, handler, fontRequestCallback);
    }
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z, int i, int i2) {
        ...
        return requestFont(context, (List<FontRequest>) Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i2, z, i, ResourcesCompat.FontCallback.getHandler(handler), resourcesCallbackAdapter);
    }
