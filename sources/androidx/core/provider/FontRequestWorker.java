...
class FontRequestWorker {
    ...
    static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWrapper callbackWrapper, final int i, int i2) {
        final String strCreateCacheId = createCacheId(Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
        ...
        if (i2 == -1) {
            TypefaceResult fontSync = getFontSync(strCreateCacheId, context, Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
        ...
        try {
            TypefaceResult typefaceResult = (TypefaceResult) RequestExecutor.submit(DEFAULT_EXECUTOR_SERVICE, new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.1
                ...
                public TypefaceResult call() {
                    return FontRequestWorker.getFontSync(strCreateCacheId, context, Person$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
                }
            }, i2);
            ...
            RequestExecutor.execute(executor, callable, new Consumer<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.4
                ...
                public void accept(TypefaceResult typefaceResult) {
                    synchronized (FontRequestWorker.LOCK) {
                        ArrayList arrayList3 = (ArrayList) FontRequestWorker.PENDING_REPLIES.get(strCreateCacheId);
                        if (arrayList3 == null) {
                            return;
                        }
