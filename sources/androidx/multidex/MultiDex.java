...
public final class MultiDex {
    ...
    private static void doInstallation(Context context, File file, File file2, String str, String str2, boolean z) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, SecurityException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        synchronized (set) {
            ...
            if (Build.VERSION.SDK_INT > 20) {
                Log.w(TAG, "MultiDex is not guaranteed to work in SDK version " + Build.VERSION.SDK_INT + ": SDK version higher than 20 should be backed by runtime with built-in multidex capabilty but it's not the case here: java.vm.version=\"" + System.getProperty("java.vm.version") + Common.QUOTE);
            }
    ...
    private static ClassLoader getDexClassloader(Context context) {
        try {
            ...
            if (Build.VERSION.SDK_INT < 14 ? (classLoader instanceof DexClassLoader) || (classLoader instanceof PathClassLoader) : (classLoader instanceof BaseDexClassLoader)) {
                return classLoader;
            }
