...
public final class UStringsKt {
    ...
    public static final String m1359toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1361toStringolVBNx4(short s, int i) {
    ...
    public static final String m1360toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1358toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Person$$ExternalSyntheticBackport0.m(data ^ Integer.MIN_VALUE, UInt.m141constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m57boximpl(UByte.m63constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Person$$ExternalSyntheticBackport0.m(data ^ Integer.MIN_VALUE, UInt.m141constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m321boximpl(UShort.m327constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM141constructorimpl = UInt.m141constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Person$$ExternalSyntheticBackport0.m(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM141constructorimpl);
                    if (Person$$ExternalSyntheticBackport0.m(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM141constructorimpl2 = UInt.m141constructorimpl(i3 * iM141constructorimpl);
            int iM141constructorimpl3 = UInt.m141constructorimpl(UInt.m141constructorimpl(iDigitOf) + iM141constructorimpl2);
            if (Person$$ExternalSyntheticBackport0.m(iM141constructorimpl3 ^ Integer.MIN_VALUE, iM141constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM141constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM220constructorimpl = ULong.m220constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (UByte$$ExternalSyntheticBackport0.m(j, jM$1) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM220constructorimpl);
                    if (UByte$$ExternalSyntheticBackport0.m(j, jM$1) > 0) {
                    }
                }
                return null;
            }
            long jM220constructorimpl2 = ULong.m220constructorimpl(j * jM220constructorimpl);
            long jM220constructorimpl3 = ULong.m220constructorimpl(ULong.m220constructorimpl(((long) UInt.m141constructorimpl(iDigitOf)) & 4294967295L) + jM220constructorimpl2);
            if (UByte$$ExternalSyntheticBackport0.m(jM220constructorimpl3, jM220constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM220constructorimpl3;
        }
        return ULong.m214boximpl(j);
    }
}
