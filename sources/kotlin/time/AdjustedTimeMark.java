...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1363minusLRDsOJo(long j) {
    ...
    public long mo1362elapsedNowUwyO8pc() {
        return Duration.m1407minusLRDsOJo(this.mark.mo1362elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1365plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1408plusLRDsOJo(this.adjustment, duration), null);
    }
}
