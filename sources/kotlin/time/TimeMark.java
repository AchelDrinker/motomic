...
public interface TimeMark {
    ...
    TimeMark mo1363minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: plus-LRDsOJo */
    TimeMark mo1365plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1509minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1365plusLRDsOJo(Duration.m1425unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1405isNegativeimpl(timeMark.mo1362elapsedNowUwyO8pc());
        }
