...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m44boximpl(Object obj) {
    ...
    private static final T m49getOrNullimpl(Object obj) {
        if (m51isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m45constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m45constructorimpl(ResultKt.createFailure(exception));
        }
    }
