...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m1282getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1283containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m214boximpl(m1284getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m214boximpl(m1285getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m214boximpl(m1286getStartsVKNKU());
    }
    ...
    public long m1284getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return ULong.m220constructorimpl(getLast() + ULong.m220constructorimpl(((long) 1) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1283containsVKZWuLQ(long value) {
        return UByte$$ExternalSyntheticBackport0.m(getFirst(), value) <= 0 && UByte$$ExternalSyntheticBackport0.m(value, getLast()) <= 0;
    }

    @Override // kotlin.ranges.ULongProgression, kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public boolean isEmpty() {
        return UByte$$ExternalSyntheticBackport0.m(getFirst(), getLast()) > 0;
    }
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m220constructorimpl(getFirst() ^ ULong.m220constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m220constructorimpl(getLast() ^ ULong.m220constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m266toStringimpl(getFirst())) + ".." + ((Object) ULong.m266toStringimpl(getLast()));
    }
