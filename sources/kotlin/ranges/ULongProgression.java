...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1254getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public boolean isEmpty() {
        ...
        long j2 = this.first;
        long j3 = this.last;
        return j > 0 ? UByte$$ExternalSyntheticBackport0.m(j2, j3) > 0 : UByte$$ExternalSyntheticBackport0.m(j2, j3) < 0;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM220constructorimpl = ((int) ULong.m220constructorimpl(j ^ ULong.m220constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM220constructorimpl2 = (iM220constructorimpl + ((int) ULong.m220constructorimpl(j2 ^ ULong.m220constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM220constructorimpl2 + ((int) (j3 ^ (j3 >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m266toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m266toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
