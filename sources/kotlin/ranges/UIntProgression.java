...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1255getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public boolean isEmpty() {
        return this.step > 0 ? Person$$ExternalSyntheticBackport0.m(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) > 0 : Person$$ExternalSyntheticBackport0.m(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) < 0;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m187toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m187toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1271fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
