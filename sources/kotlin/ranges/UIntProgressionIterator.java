...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        boolean z = true;
        if (i3 <= 0 ? Person$$ExternalSyntheticBackport0.m(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) < 0 : Person$$ExternalSyntheticBackport0.m(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) > 0) {
            z = false;
        }
        this.hasNext = z;
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m135boximpl(m1272nextpVg5ArA());
    }
