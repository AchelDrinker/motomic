...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m558containsVKZWuLQ(((ULong) obj).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m214boximpl(m559getsVKNKU(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m560indexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m561lastIndexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return ULongArray.m281getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m283isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m558containsVKZWuLQ(long element) {
        return ULongArray.m276containsVKZWuLQ(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public long m559getsVKNKU(int index) {
        return ULongArray.m280getsVKNKU(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-VKZWuLQ, reason: not valid java name */
    public int m560indexOfVKZWuLQ(long element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-VKZWuLQ, reason: not valid java name */
    public int m561lastIndexOfVKZWuLQ(long element) {
