...
public final class UnsignedKt {
    ...
    public static final int m398uintRemainderJ1ME1BU(int i, int i2) {
    ...
    public static final int m397uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m141constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m399ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return UByte$$ExternalSyntheticBackport0.m(j, j2) < 0 ? ULong.m220constructorimpl(0L) : ULong.m220constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m220constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m220constructorimpl(j3 + ((long) (UByte$$ExternalSyntheticBackport0.m(ULong.m220constructorimpl(j - (j3 * j2)), ULong.m220constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m400ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return UByte$$ExternalSyntheticBackport0.m(j, j2) < 0 ? j : ULong.m220constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m220constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (UByte$$ExternalSyntheticBackport0.m(ULong.m220constructorimpl(j3), ULong.m220constructorimpl(j2)) < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        Double.isNaN(d2);
        return UInt.m141constructorimpl(UInt.m141constructorimpl((int) (d - d2)) + UInt.m141constructorimpl(Integer.MAX_VALUE));
    }
