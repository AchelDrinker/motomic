        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (hashedWeakRef != null) {
                    ...
                    if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), iIndex, null, weakKey0)) {
                        break;
                    }
                } else {
                    return null;
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), iIndex, obj, value));
            return obj;
        }
            ...
            while (true) {
                ...
                while (i < i2) {
                    ...
                    while (true) {
                        obj = getValues().get(i);
                        if (!(obj instanceof Marked)) {
                            if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), i, obj, ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
