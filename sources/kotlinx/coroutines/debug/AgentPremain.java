...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM45constructorimpl = Result.m45constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m51isFailureimpl(objM45constructorimpl) ? null : objM45constructorimpl);
