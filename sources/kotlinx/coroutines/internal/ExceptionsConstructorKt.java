...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM45constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM45constructorimpl = Result.m45constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m51isFailureimpl(objM45constructorimpl)) {
                objM45constructorimpl = null;
            }
            return (E) objM45constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM45constructorimpl = Result.m45constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m51isFailureimpl(objM45constructorimpl) ? null : objM45constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM45constructorimpl = Result.m45constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m51isFailureimpl(objM45constructorimpl)) {
            objM45constructorimpl = numValueOf;
        }
        return ((Number) objM45constructorimpl).intValue();
    }
