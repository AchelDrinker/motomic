...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation$kotlinx_coroutines_core() {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuationImpl) {
                if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
    ...
    public final Throwable tryReleaseClaimedContinuation$kotlinx_coroutines_core(CancellableContinuation<?> continuation) {
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (obj instanceof Throwable) {
                    if (!UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, this, obj, null)) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation$kotlinx_coroutines_core(Throwable cause) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (obj instanceof Throwable) {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context2)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo1604dispatch(context2, this);
            return;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x009c A[Catch: all -> 0x00b3, DONT_GENERATE, TryCatch #0 {all -> 0x00b3, blocks: (B:10:0x0044, B:12:0x0054, B:14:0x005a, B:25:0x009f, B:15:0x0077, B:17:0x0087, B:22:0x0096, B:24:0x009c, B:30:0x00a9, B:33:0x00b2, B:32:0x00af, B:20:0x008d), top: B:42:0x0044, inners: #1 }] */
    /*
    ...
    */
    public final void resumeCancellableWith$kotlinx_coroutines_core(java.lang.Object r8, kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit> r9) {
        ...
        L3d:
            ...
            java.lang.Object r8 = kotlin.Result.m45constructorimpl(r8)     // Catch: java.lang.Throwable -> Lb3
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        resumeWith(Result.m45constructorimpl(ResultKt.createFailure(cancellationException)));
        return true;
    }
