...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM45constructorimpl = Result.m45constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m48exceptionOrNullimpl(objM45constructorimpl) == null) {
            obj2 = objM45constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM45constructorimpl2 = Result.m45constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM45constructorimpl2 = Result.m45constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m48exceptionOrNullimpl(objM45constructorimpl2) == null) {
            obj = objM45constructorimpl2;
        }
