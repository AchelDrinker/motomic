...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode affected, Object failure) {
            ...
            if (lockFreeLinkedListNode != null && UByte$$ExternalSyntheticBackport0.m(LockFreeLinkedListNode.get_next$volatile$FU(), affected, this, lockFreeLinkedListNode) && z) {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode node) {
        ...
        while (getNext() == this) {
            if (UByte$$ExternalSyntheticBackport0.m(_next$volatile$FU, this, this, node)) {
                node.finishAdd(this);
                return true;
            }
        }
    ...
    public final boolean addNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next) {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(_next$volatile$FU, this, next, node)) {
            return false;
        }
        node.finishAdd(next);
        return true;
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next, CondAddOp condAdd) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(_next$volatile$FU, this, next, condAdd)) {
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_next$volatile$FU, this, next, lockFreeLinkedListNode.removed()));
    ...
    public final void finishAdd(LockFreeLinkedListNode next) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_prev$volatile$FU, next, lockFreeLinkedListNode, this));
        if (isRemoved()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x004b, code lost:
        ...
        if (kotlin.UByte$$ExternalSyntheticBackport0.m(kotlinx.coroutines.internal.LockFreeLinkedListNode._next$volatile$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L25;
     */
    /*
    ...
    */
    private final kotlinx.coroutines.internal.LockFreeLinkedListNode correctPrev(kotlinx.coroutines.internal.OpDescriptor r8) {
        ...
        L1a:
            ...
            boolean r0 = kotlin.UByte$$ExternalSyntheticBackport0.m(r1, r7, r0, r2)
            if (r0 != 0) goto L2e
            goto L0
        L25:
        ...
        L39:
            ...
            boolean r2 = kotlin.UByte$$ExternalSyntheticBackport0.m(r5, r3, r2, r4)
            if (r2 != 0) goto L4e
            goto L0
        L4e:
            r2 = r3
