...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                Throwable th2 = cause;
                th = th2;
                if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th2, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else {
                th = cause;
                if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, null, null, null, th, 14, null))) {
                    return;
                }
            }
            cause = th;
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        UByte$$ExternalSyntheticBackport0.m(_parentHandle$volatile$FU, this, null, disposableHandleInvokeOnCompletion$default);
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, handler)) {
                    return;
                }
            } else {
                if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                    ...
                    if (obj instanceof CompletedContinuation) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, obj2, i, function1, null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i);
                    return;
                } else {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                Function1<? super Throwable, Unit> function1 = onCancellation;
                if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, obj2, this.resumeMode, function1, obj3))) {
                    detachChildIfNonResuable();
