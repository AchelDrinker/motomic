...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C01161 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01161(SelectImplementation<R> selectImplementation, Continuation<? super C01161> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.SelectImplementation.C01161
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C01161) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public void invoke(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L14:
            ...
            boolean r3 = kotlin.UByte$$ExternalSyntheticBackport0.m(r4, r6, r3, r1)
            if (r3 == 0) goto L14
            r2 = r6
        ...
        L2f:
            ...
            boolean r4 = kotlin.UByte$$ExternalSyntheticBackport0.m(r4, r6, r3, r5)
            if (r4 == 0) goto L14
            r4 = r3
