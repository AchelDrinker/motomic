...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1605scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1536delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1537toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1537toDelayMillisLRDsOJo(long j) {
        boolean zM1406isPositiveimpl = Duration.m1406isPositiveimpl(j);
        if (zM1406isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1390getInWholeMillisecondsimpl(Duration.m1408plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1406isPositiveimpl) {
