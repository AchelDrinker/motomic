...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C00971 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C00971) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", f = "Errors.kt", i = {}, l = {KeyCodes.KEYCODE_MUTE}, m = "invokeSuspend", n = {}, s = {})
    ...
    */
    ...
    public static final <T> Flow<T> m1588catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
