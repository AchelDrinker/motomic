...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m1591WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m1475getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m1473getINFINITEUwyO8pc();
        }
        return m1590WhileSubscribed5qebJ5I(companion, j, j2);
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I, reason: not valid java name */
    public static final SharingStarted m1590WhileSubscribed5qebJ5I(SharingStarted.Companion companion, long j, long j2) {
        return new StartedWhileSubscribed(Duration.m1390getInWholeMillisecondsimpl(j), Duration.m1390getInWholeMillisecondsimpl(j2));
    }
}
