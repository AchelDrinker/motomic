...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1581debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1537toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1537toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C00962<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00962(long j, Flow<? extends T> flow, Continuation<? super C00962> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C00962 c00962 = new C00962(this.$periodMillis, this.$this_sample, continuation);
            c00962.L$0 = coroutineScope;
            c00962.L$1 = flowCollector;
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C00962(j, flow, null));
    }
    ...
    public static final <T> Flow<T> m1582sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1537toDelayMillisLRDsOJo(j));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1583timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m1584timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m1584timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
