...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) throws Throwable {
        ...
        boolean zM = UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, JobSupportKt.boxIncomplete(proposedUpdate));
    ...
    private final boolean tryFinalizeSimpleState(Incomplete state, Object update) throws Throwable {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, JobSupportKt.boxIncomplete(update))) {
            return false;
        }
        onCancelling(null);
    ...
    */
    ...
    private final int startInternal(Object state) {
        if (state instanceof Empty) {
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, JobSupportKt.EMPTY_ACTIVE)) {
                return -1;
            }
            onStart();
            return 1;
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, ((InactiveNodeList) state).getList())) {
            return -1;
        }
        onStart();
        return 1;
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.getIsActive()) {
                    if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state$kotlinx_coroutines_core, jobNodeMakeNode)) {
    ...
    private final void promoteEmptyToNodeList(Empty state) {
        ...
        UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, state.getIsActive() ? nodeList : new InactiveNodeList(nodeList));
    }

    private final void promoteSingleToNodeList(JobNode state) {
        state.addOneIfEmpty(new NodeList());
        UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, state.getNextNode());
    }
    ...
    private final boolean tryMakeCancelling(Incomplete state, Throwable rootCause) throws Throwable {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, new Finishing(orPromoteCancellingList, false, rootCause))) {
            return false;
        }
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete state, Object proposedUpdate) throws Throwable {
        ...
        synchronized (finishing) {
            ...
            if (finishing != state && !UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state, finishing)) {
                return JobSupportKt.COMPLETING_RETRY;
            }
    ...
    */
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode node) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, this, state$kotlinx_coroutines_core, JobSupportKt.EMPTY_ACTIVE));
    }
