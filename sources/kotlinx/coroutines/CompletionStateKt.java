...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(thM48exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (DebugKt.getRECOVER_STACK_TRACES()) {
            ...
            if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                thM48exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM48exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
            }
        }
        return new CompletedExceptionally(thM48exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m45constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }
