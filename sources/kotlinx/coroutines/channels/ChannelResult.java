...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1559boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1560constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1561equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1562equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m1566hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m1561equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1566hashCodeimpl(this.holder);
    }
    ...
    public static final boolean m1567isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m1564getOrNullimpl(Object obj) {
    ...
    public static final T m1565getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1563exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1574successJP2dKIU(E value) {
            return ChannelResult.m1560constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m1573failurePtdJZtk() {
            return ChannelResult.m1560constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m1572closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1560constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m1570toStringimpl(this.holder);
    }
