...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM1576trySendImplMj0NB7M = conflatedBufferedChannel.m1576trySendImplMj0NB7M(e, true);
        if (objM1576trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1563exceptionOrNullimpl(objM1576trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM1576trySendImplMj0NB7M = conflatedBufferedChannel.m1576trySendImplMj0NB7M(e, true);
        if (!(objM1576trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1548trySendJP2dKIU(E element) {
        return m1576trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1576trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1575trySendDropLatestMj0NB7M(element, isSendOp) : m1554trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1575trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo1548trySendJP2dKIU = super.mo1548trySendJP2dKIU(element);
        if (ChannelResult.m1569isSuccessimpl(objMo1548trySendJP2dKIU) || ChannelResult.m1567isClosedimpl(objMo1548trySendJP2dKIU)) {
            return objMo1548trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo1548trySendJP2dKIU = mo1548trySendJP2dKIU(element);
        if (!(objMo1548trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo1548trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1563exceptionOrNullimpl(objMo1548trySendJP2dKIU);
