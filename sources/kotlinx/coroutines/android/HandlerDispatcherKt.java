...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM45constructorimpl = Result.m45constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM45constructorimpl = Result.m45constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m51isFailureimpl(objM45constructorimpl) ? null : objM45constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1604dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
