...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!UByte$$ExternalSyntheticBackport0.m(lastScheduledTask$volatile$FU, this, task, null));
        return task;
    }
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(lastScheduledTask$volatile$FU, this, r0, null));
