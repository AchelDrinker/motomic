...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1605scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
    ...
    public final void mo1604dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, null, task)) {
                    return true;
                }
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore)) {
                    return true;
                }
            } else {
                ...
                if (iAddLast == 1) {
                    UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore2.next());
                } else if (iAddLast == 2) {
                    return false;
                }
            }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(obj instanceof LockFreeTaskQueueCore)) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, obj, null)) {
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                    return (Runnable) obj;
                }
            } else {
                ...
                UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore.next());
            }
        }
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            Object obj = atomicReferenceFieldUpdater.get(this);
            if (obj == null) {
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, this, null, EventLoop_commonKt.CLOSED_EMPTY)) {
                    return;
                }
            } else if (!(obj instanceof LockFreeTaskQueueCore)) {
                if (obj == EventLoop_commonKt.CLOSED_EMPTY) {
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            UByte$$ExternalSyntheticBackport0.m(_delayed$volatile$FU, this, null, new DelayedTaskQueue(now));
